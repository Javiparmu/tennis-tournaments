...
import { mergeDefined, optimistic, removeById, setMutationNotifier, updateById } from "./optimistic";

// The danger-toast channel is injected by the host app; here we inject a spy and
// assert it was invoked on error, without pulling in any UI layer.
