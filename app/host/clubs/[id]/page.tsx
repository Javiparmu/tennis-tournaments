        ...
        <>
          ...
          {!canManage ? (
            <p className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700">
              Estás viendo este club pero no eres propietario ni administrador, por lo que las acciones de gestión están
              ocultas.
            </p>
          ) : null}
              ...
              <div className="rounded-2xl border border-court/10 bg-white p-5 shadow-sm">
                ...
                {canManage ? (
                  <form
                    ...
                    className="mt-4 flex items-center gap-2 border-t border-court/10 pt-4"
                  >
                    <input
                      type="number"
                      min="1"
